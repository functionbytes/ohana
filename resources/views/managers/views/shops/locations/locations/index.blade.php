            ...
            @section('content')
                ...
                @include('managers.includes.card', ['title' => 'Ubicaciones '.$shop->title])
                            ...
                            <table class="table search-table align-middle text-nowrap">
                                ...
                                @foreach ( $locations as $key =>  $location)
                                    <tr class="search-items">
                                        <td>
                                            <span class="usr-email-addr" >{{  $location->title  }}</span>
                                        </td>
                                        <td>
                                            <span class="badge {{  $location->available == 1 ? 'bg-light-primary' : 'bg-light-secondary' }} rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
                                                       {{  $location->available == 1 ? 'Completado' : 'Pendiente' }}
                                            </span>
                                        </td>
                                        <td>
                                            <span class="usr-ph-no" >{{ date('Y-m-d', strtotime( $location->updated_at)) }}</span>
                                        </td>
                                        <td class="text-left">
