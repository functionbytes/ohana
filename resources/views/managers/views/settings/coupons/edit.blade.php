        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            ...
            @php
                $coupon_bundles = null;
                                 ...
                                 if (!is_null($coupon->course_ids)) {
                                     $coupon_courses = \App\Models\Group\Course\Course::whereIn('id', explode(',',$coupon->course_ids))->pluck('id');
                                 }

                                 if (!is_null($coupon->bundle_ids)) {
                                     $coupon_bundles = \App\Models\Bundle\Bundle::whereIn('id', explode(',',$coupon->bundle_ids))->pluck('id');
                                 }
            ...
            <div class="card w-100">
                ...
                <form id="formCoupons" enctype="multipart/form-data" role="form" onSubmit="return false">
                    ...
                    <input type="hidden" id="uid" name="uid" value="{{ $coupon->uid }}">
                    <textarea style="display: none" id="description"
                              name="description">{!!$coupon->descriptions !!}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                           value="{{ $coupon->title }}" placeholder="Ingresar titulo">
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code"
                                           value="{{ $coupon->code }}" placeholder="Ingresar codigo">
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="min_price" name="min_price"
                                           value="{{ $coupon->min_price }}" placeholder="Ingresar precio minimo">
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="amount" name="amount"
                                           value="{{ $coupon->amount }}" placeholder="Ingresar precio minimo">
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="limit" name="limit"
                                           value="{{ $coupon->limit }}" placeholder="Ingresar precio minimo">
                                </div>
                            </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control date-range-picker date-range" type="text"
                                               placeholder="Fecha de inicio - Fecha de término" name="date_range"
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        {!! Form::select('courses[]', $courses, $coupon_courses, ['class' => 'select2 form-control'  , 'multiple' => 'multiple' , 'id' => 'courses']) !!}
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        {!! Form::select('bundles[]', $bundles, $coupon_bundles, ['class' => 'select2 form-control'  , 'multiple' => 'multiple' , 'id' => 'bundles']) !!}
                                    </div>
