                ...
                <div class="col-md-12 col-xl-12">
                    <form class="position-relative form-search" action="{{ Request::fullUrl() }}" method="GET">
                        <div class="row justify-content-between g-2 ">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('manager.enterprises.users.create', $enterprise->uid) }}" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Crear">
                                    <i class="fa-duotone fa-plus"></i>
                                </a>
                            </div>

                            <div class="col-auto">
                                <a href="{{ route('manager.enterprises.users.reports', $enterprise->uid) }}" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reporte">
                            ...
                            <td class="text-left">
                                <div class="dropdown dropstart">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.enterprises.users.courses', $user->uid) }}">
                                                Cursos
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.enterprises.users.certificates', $user->uid) }}">
                                                Certificados
                                            </a>
                                        </li>

                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.enterprises.users.edit', $user->uid) }}">
                                                Gestionar
                                            </a>
                                        </li>
