              ...
              <td class="text-left">
                <div class="dropdown dropstart">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <li>
                      <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.enterprises.navegation', $enterprise->uid) }}">Dashboard</a>
                    </li>
                    <li>
                      <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.enterprises.edit', $enterprise->uid) }}">Editar</a>
                    </li>
                    <li>
                      <a class="dropdown-item d-flex align-items-center gap-3 confirm-delete" data-href="{{ route('manager.enterprises.destroy', $enterprise->uid) }}">Eliminar</a>
                    </li>
                  </ul>
                </div>
              </td>
