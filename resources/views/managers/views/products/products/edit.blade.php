                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title"  name="title" value="{{ $product->title }}" placeholder="Ingresar nombre">
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="barcode"  name="barcode" value="{{ $product->barcode }}" placeholder="Ingresar nombre">
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="reference"  name="reference" value="{{ $product->reference }}" placeholder="Ingresar nombre">
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        {!! Form::select('available', $availables, $product->available , ['class' => 'select2 form-control','id' => 'available']) !!}
                                    </div>
