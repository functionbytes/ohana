...
<html lang="en">
    <head>
        ...
        <!-- Theme -->
    <link rel="stylesheet" type="text/css" href="{{ asset('core/css/theme/'.App\Models\::get('frontend_scheme').'.css') }}">
    </head>
    <body class="bg-slate-800 theme-{{ App\Models\::get('frontend_scheme') }} login-page">
        <!-- Page container -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-6 col-lg-4">
                            ...
                            <div class="text-center login-header">
                                <a class="main-logo-big" href="{{ route('manager.dashboard') }}">
                                    <img src="{{ in_array(App\Models\::get('frontend_scheme'), ['supermail','white']) ? getSiteLogoUrl('dark') : getSiteLogoUrl('light') }}" alt="">
                                </a>
                            </div>
