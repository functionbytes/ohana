        ...
        <div class="collapse navbar-collapse" id="mainAppNav">
            <ul class="navbar-nav me-auto mb-md-0 main-menu">
                ...
                <li class="nav-item {{ $menu == 'profile' ? 'active' : '' }}">
                    <a title="{{ trans('messages.my_profile') }}" href="{{ route("AccountController@profile") }}" class="leftbar-tooltip nav-link d-flex align-items-center py-3 lvl-1">
                        <i class="navbar-icon">
                ...
                <li class="nav-item {{ $menu == 'contact' ? 'active' : '' }}">
                    <a title="{{ trans('messages.contact_information') }}" href="{{ route("AccountController@contact") }}" class="leftbar-tooltip nav-link d-flex align-items-center py-3 lvl-1">
                        <i class="navbar-icon">
                ...
                <li class="nav-item {{ $menu == 'billing' ? 'active' : '' }}">
                    <a title="{{ trans('messages.billing') }}" href="{{ route("AccountController@billing") }}" class="leftbar-tooltip nav-link d-flex align-items-center py-3 lvl-1">
                        <i class="navbar-icon">
                ...
                <li class="nav-item {{ $menu == 'subscription' ? 'active' : '' }}">
                    <a title="{{ trans('messages.billing') }}" href="{{ route("SubscriptionController@index") }}" class="leftbar-tooltip nav-link d-flex align-items-center py-3 lvl-1">
                        <i class="navbar-icon">
                ...
                <li class="nav-item {{ $menu == 'log' ? 'active' : '' }}">
                    <a title="{{ trans('messages.billing') }}" href="{{ route("AccountController@logs") }}" class="leftbar-tooltip nav-link d-flex align-items-center py-3 lvl-1">
                        <i class="navbar-icon">
                ...
                <li class="nav-item {{ $menu == 'api' ? 'active' : '' }}">
                    <a title="{{ trans('messages.billing') }}" href="{{ route("AccountController@api") }}" class="leftbar-tooltip nav-link d-flex align-items-center py-3 lvl-1">
                        <i class="navbar-icon">
