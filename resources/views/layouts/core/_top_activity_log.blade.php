...
<script>
	...
	$(function() {
		$('.activities-menu-item').on('click', function() {
			...
			if(!sidebar.showed()) {
				sidebar.load({
					url: '{{ route('AccountController@activity') }}'
				});
			} else {
				sidebar.hide();
			}
