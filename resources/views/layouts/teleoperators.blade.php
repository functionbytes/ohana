...
<head>
    ...
    <link rel="stylesheet" href="{{ url('managers/libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ url('inventaries/css/style.css') }}">
...
<script>
    ...
    $(function () {
        ...
        $.datepicker.setDefaults({
            ...$.datepicker.regional["es"], // si usas idioma
            dateFormat: 'yy-mm-dd',         // ✅ MUY IMPORTANTE
            minDate: 0,
            changeMonth: true,
            changeYear: true,
            onSelect: function (dateText, inst) {
                $(this).val(dateText); // 🔐 forzar valor correcto
        ...
        $('.picker').each(function () {
            ...
            if (value && /^\d{4}-\d{2}-\d{2}$/.test(value)) {
                $(this).datepicker('setDate', $.datepicker.parseDate('yy-mm-dd', value));
            }
        });
