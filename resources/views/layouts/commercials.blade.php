...
<div class="page-wrapper" id="main-wrapper" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed"
    ...
    @include ('commercials.includes.nav')

    <!-- Main wrapper -->

    <div class="body-wrapper">

        @include ('commercials.includes.header')

        <div class="container-fluid">
            @yield('content')
        </div>

        @include ('commercials.includes.delete')
...
<script src="{{ url('managers/libs/select2/dist/min/dropzone.min.js') }}" type="text/javascript"></script>
