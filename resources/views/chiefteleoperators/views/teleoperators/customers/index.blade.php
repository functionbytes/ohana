...
@section('content')
    ...
    @include('managers.includes.card', ['title' => 'Clientes'])
    ...
    <div class="widget-content searchable-container list">
                ...
                <div class="col-md-12 col-xl-12">
                    <form class="position-relative form-search" action="{{ request()->fullUrl() }}" method="GET">
                        <div class="row justify-content-between g-2 ">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('teleoperator.customers.create') }}" class="btn btn-primary">
        ...
        <div class="card card-body">
                ...
                <table class="table search-table align-middle text-nowrap">
                    ...
                    @foreach ($customers as $key => $customer)
                        <tr class="search-items">
                            <td>
                                <span class="usr-email-addr" >{{ $customer->full_name }}</span>
                            </td>
                            <td>
                                <span class="usr-email-addr" >{{ $customer->cellphone }}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="usr-ph-no" data-phone="{{ date('Y-m-d', strtotime($customer->updated_at)) }}">{{ date('Y-m-d', strtotime($customer->updated_at)) }}</span>
                            </td>
                            <td class="text-left">
                                <div class="dropdown dropstart">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('teleoperator.customers.view', $customer->uid) }}">
                                                Logs
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('teleoperator.customers.edit', $customer->uid) }}">
                                                Editar
                                            </a>
                                        </li>
                                    </ul>
            ...
            <div class="result-body ">
                <span>Mostrar {{ $customers->firstItem() }}-{{ $customers->lastItem() }} de {{ $customers->total() }} resultados</span>
                <nav>
