                            ...
                            <div class="row col-lg-8 col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item "><a href="{{ route('manager.teams') }}">Equipo</a></li>
                                    </ol>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-12">
                                <div class="justify-content-add">
                                    <a href="{{ route('manager.teams.create') }}" id="btn-add-contact" class="btn btn-primary rounded text-white content-btn-add">Agregar</a>
                                </div>
                            </div>
                </div>
            <div class="row">
                                    ...
                                    <tbody id="customers">
                                        @foreach($teams as $team)
                                            <tr class="btn-reveal-trigger">
                                                ...
                                                <td class="py-2">{{ humanize_date($team->created_at) }}</td>
