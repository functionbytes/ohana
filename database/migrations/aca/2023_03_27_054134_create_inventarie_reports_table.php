...
class CreateInventarieReportsTable extends Migration
{
    ...
    public function up()
    {
            ...
            Schema::create('inventarie_reports', function (Blueprint $table) {
                ...
                $table->foreign('location_original_id')->references('id')->on('locations')->onUpdate('cascade')->onDelete('cascade');
                $table->foreign('location_validate_id')->references('id')->on('locations')->onUpdate('cascade')->onDelete('cascade');
                $table->foreign('condition_id')->references('id')->on('condition_reports')->onUpdate('cascade')->onDelete('cascade');
