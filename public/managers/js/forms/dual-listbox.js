...
//********************************//
$(function () {
  $(".moveall i").removelessons().addClass("ti ti-chevron-right");
  $(".removeall i").removelessons().addClass("ti ti-chevron-left");
  $(".move i").removelessons().addClass("ti ti-chevron-right");
  $(".remove i").removelessons().addClass("ti ti-chevron-left");
});
