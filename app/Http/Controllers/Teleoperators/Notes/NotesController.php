...
class NotesController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('teleoperators.views.notes.notes.index')->with([
            'notes' => $notes,
            'searchKey' => $searchKey,
            'statuses' => $statuses,
            'status' => $status,
    ...
    public function edit($uid){
        ...
        return view('teleoperators.views.notes.notes.edit')->with([
            'note' => $note,
            'customer' => $customer,
            'status' => $status,
            'schedules' => $schedules,
    ...
    public function create()
    {
        ...
        return view('teleoperators.views.notes.notes.create')->with([
    ...
    public function generate($uid)
    {
        ...
        return view('teleoperators.views.notes.notes.generate')->with([
            'status' => $status,
            'schedules' => $schedules,
            'cellphone' => $uid,
        ]);
