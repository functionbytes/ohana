...
namespace App\Http\Controllers\Teleoperators\Customers;
...
class CustomersController extends Controller
{
    public function index(Request $request){
        ...
        return view('teleoperators.views.customers.customers.index')->with([
            'customers' => $customers,
            'searchKey' => $searchKey,
        ]);
    }
    public function create()
    {
        ...
        return view('teleoperators.views.customers.customers.create')->with([
    ...
    public function view($uid)
    {
        ...
        return view('teleoperators.views.customers.customers.view')->with([
            'customer' => $customer,
            'notes' => $notes,
            'contracts' => $contracts,
        ]);
    ...
    public function edit($uid)
    {
        ...
        return view('teleoperators.views.customers.customers.edit')->with([
            'customer' => $customer,
            'postalcodes' => $postalcodes,
        ]);
