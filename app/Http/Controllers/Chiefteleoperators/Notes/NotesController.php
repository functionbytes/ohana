...
namespace App\Http\Controllers\chiefteleoperators\Notes;
...
class NotesController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $notes = Note::latest();
        $statuses = NoteStatuses::pluck('title', 'id')->prepend('Todos', 0);
        ...
        return view('chiefteleoperators.views.notes.notes.index')->with([
            'notes' => $notes,
            'searchKey' => $searchKey,
            'statuses' => $statuses,
            'status' => $status,
    ...
    public function edit($uid){
        ...
        return view('chiefteleoperators.views.notes.notes.edit')->with([
            'note' => $note,
            'customer' => $customer,
            'status' => $status,
            'schedules' => $schedules,
    ...
    public function view($uid){
        ...
        return view('chiefteleoperators.views.notes.notes.view')->with([
            'note' => $note,
            'customer' => $customer,
            'histories' => $histories,
        ]);
    ...
    public function create()
    {
        ...
        return view('chiefteleoperators.views.notes.notes.create')->with([
    ...
    public function generate($uid)
    {
        ...
        return view('chiefteleoperators.views.notes.notes.generate')->with([
            'status' => $status,
            'schedules' => $schedules,
            'cellphone' => $uid,
        ]);
    ...
    public function reschedule($uid)
    {
        ...
        return view('chiefteleoperators.views.notes.notes.reschedule')->with([
            'status' => $status,
            'schedules' => $schedules,
            'note' => $note,
            'customer' => $customer,
