...
namespace App\Http\Controllers\chiefteleoperators\Customers;
...
class CustomersController extends Controller
{
    public function index(Request $request){
        ...
        return view('chiefteleoperators.views.customers.customers.index')->with([
            'customers' => $customers,
            'searchKey' => $searchKey,
        ]);
    }
    public function create()
    {
        ...
        return view('chiefteleoperators.views.customers.customers.create')->with([
    ...
    public function view($uid)
    {
        ...
        return view('chiefteleoperators.views.customers.customers.view')->with([
            'customer' => $customer,
            'postalcodes' => $postalcodes,
        ]);
    ...
    public function edit($uid)
    {
        ...
        return view('chiefteleoperators.views.customers.customers.edit')->with([
            'customer' => $customer,
            'postalcodes' => $postalcodes,
        ]);
