...
class SegmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!$list) {
            return redirect()->action('SegmentController@noList');
        }

        return view('managers.views.maillists.segments.index', [
            'list' => $list,
        ]);
    }
    ...
    {
        // authorize
        if (\Gate::denies('list', \Acelle\Model\Segment::class)) {
        ...
        return view('managers.views.maillists.segments._list', [
            'segments' => $segments,
            'list' => $list,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('managers.views.maillists.segments.create', [
            'list' => $list,
            'segment' => $segment,
        ]);
    }
    ...
    public function subscribers(Request $request)
    {
        ...
        return view('managers.views.maillists.segments.subscribers', [
    ...
    public function listing_subscribers(Request $request)
    {
        ...
        $fields = $list->getFields->whereIn('uid', $request->columns_);
    ...
    public function edit(Request $request)
    {
        ...
        return view('managers.views.maillists.segments.edit', [
            'list' => $list,
            'segment' => $segment,
        ]);
    }
    ...
    public function sample_condition(Request $request)
    {
        ...
        return view('managers.views.maillists.segments._sample_condition', [
            'list' => $list,
        ]);
    }
    ...
    public function selectBox(Request $request)
    {
        ...
        return view('managers.views.maillists.segments._select_box', [
    ...
    public function conditionValueControl(Request $request)
    {
        ...
        // legacy code
        return view('managers.views.maillists.segments._condition_value_control', [
    ...
    {
        return view('managers.views.maillists.segments.noList');
    }
}
